...
class DDHIIngestSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['source_type'] = [
      ...
      '#default_value' => DDHI_SOURCE_OPTION_GITHUB,
    ];
    ...
    $form['source_type_github']['github_account'] = [
      ...
      '#default_value' => !empty($form_state->getValue('github_account')) ? $form_state->getValue('github_account') : 'Dartmouth-Digital-History-Initiative',
    ...
    $form['source_type_github']['github_repository'] = [
      ...
      '#default_value' => !empty($form_state->getValue('github_repository')) ? $form_state->getValue('github_repository') : 'TEI-Encoding',
    ...
    $form['source_type_github']['github_branch'] = [
      ...
      '#default_value' => !empty($form_state->getValue('github_branch')) ? $form_state->getValue('github_branch') : 'master',
