...
customElements.define('ddhi-viewer', class extends DDHIDataComponent {
  ...
  async connectedCallback() {
    ...
    // this.viewer is used in the parent Data componentÕs propagation system and
    // is derived from a selection query of an elementÕs parents. This will return
  ...
  //   and fire the componentÕs handler. 
