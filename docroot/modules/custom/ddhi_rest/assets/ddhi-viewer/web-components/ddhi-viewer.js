...
class DDHIViewHelper {
  ...
  // Font canŐt be loaded directly into the ShadowDOM, they can
...
class DDHIDataComponent extends HTMLElement {
  ...
  propagateAttributes(attr,value) {
    ...
    // Propagate to all elements marked with a ńpropagateî attribute
...
customElements.define('ddhi-viewer', class extends DDHIDataComponent {
  ...
  async connectedCallback() {
    ...
    // this.viewer is used in the parent Data componentęs propagation system and
    // is derived from a selection query of an elementęs parents. This will return
  ...
  //   and fire the componentęs handler.
